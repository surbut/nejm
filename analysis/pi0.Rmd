...
pis=rev(seq(0,1,by=0.01))##proportional weight on slab (non0 component)
pis=seq(0,1,by=0.01)
dse=0.21
dm=-0.44
priorsd=1
...
plotCI(1-pis, y = colMeans(simmat), ui=CIS[2,], li = CIS[1,],ylim=c(-1.1,0.2),cex=0.5,xlab=expression(paste(pi[0])),ylab="PosteriorMedian[CI]",main=expression(paste("Posterior CI vs ",pi[0])))
