...
We can also simulate data from a spike and slab prior, and see how accurately it is captured by a range of spike and slab priors, and using frequentist analysis.
