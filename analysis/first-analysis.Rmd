...
$$\tilde \pi = p(z=k|data) = \frac{p(data|z=k)}{\sum_k{p(data|z=k)}}=\frac{p(data|z=k)}{\pi_{0} p(data|\delta_{0})+\pi_{1} p(data|N(0,1))}$$

Becuase the probability of having a non-zero observation arise from the $\delta_{0}$ component is 0, we use a trivially small value of $\sigma^2$ for this component.
