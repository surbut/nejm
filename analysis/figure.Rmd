...
probdeath.single=rbeta(100000,1,0.01,.01)
problife.single=1-probdeath.single

probdeath.multi=rbeta(100000,1,0.01,.01)
problife.multi=1-rbeta(100000,1,0.01,.01)


logOR=log((probdeath.single/probdeath.multi)/(problife.single/problife.multi))
```

If we then do a histogram of the nonNA logOR2:
```{r}
hist(logOR[!is.na(logOR)],freq=FALSE)
```
